...
public class PoolManager : MonoBehaviour
{
    ...
    public class Pool
    {
        public PoolObjectType type; // key 값
    ...
    private Dictionary<PoolObjectType, List<PoolObject>> poolDictionary;


    private void Awake()
    {
        // 딕셔너리 초기화
        poolDictionary = new Dictionary<PoolObjectType, List<PoolObject>>();
    ...
    private void AddPoolObject(PoolObjectType type) // 프리팹 생성
    {
    ...
    public PoolObject SpawnFromPool(PoolObjectType type)
    {
